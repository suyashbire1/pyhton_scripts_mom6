...
#        ax[2].set_ylabel('')
    ...
    domain = Domain.Domain2(
        geofil, vgeofil, xstart, xend, ystart, yend, ls=0, le=1)
    with mfdset(fil) as fh:
        e = gv('e', domain, 'hi', fh).read_array()
        cs = ax[0].contour(
            e.dom.lonh[e._plot_slice[3, 0]:e._plot_slice[3, 1]],
