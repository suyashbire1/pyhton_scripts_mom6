...
def extract_twapv_terms(geofil,vgeofil,fil,fil2,xstart,xend,ystart,yend,
        zs,ze,meanax,fil3=None, 
        calledfromgeteddycoeffs=False,alreadysaved=False):
    ...
    if not alreadysaved:
        ...
        if not calledfromgeteddycoeffs:
            ...
            (xs,xe),(ys,ye),dimq = rdp1.getdimsbyindx(fh,xstart,xend,ystart,yend,
